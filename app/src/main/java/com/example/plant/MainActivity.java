...
import com.example.plant.fragment.NewsFragment;
import com.example.plant.fragment.PostFragment;
import com.example.plant.fragment.ServiceFragment;
import com.example.plant.fragment.UserFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] titles={"首页","宝典","论坛","商城","用户中心"};
    private int[] unSele = {R.mipmap.user1,R.mipmap.user1,R.mipmap.user1,R.mipmap.user1,R.mipmap.user1};
    private int[] onSele = {R.mipmap.user1,R.mipmap.user1,R.mipmap.user1,R.mipmap.user1,R.mipmap.user1};
